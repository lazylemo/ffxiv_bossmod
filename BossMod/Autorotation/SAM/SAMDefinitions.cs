...
namespace BossMod.SAM
{
    public enum AID : uint
    {
        ...
        Enpi = 7486, // L15, instant, range 20, single-target 0/0, targets=hostile, animLock=???
        ...
        Mangetsu = 7484, // L35, instant, range 0, AOE circle 5/0, targets=self, animLock=???
        Kasha = 7482, // L40, instant, range 3, single-target 0/0, targets=hostile, animLock=0.600s
        TenkaGoken = 7488, // L40, 1.8s cast, range 0, AOE circle 8/0, targets=self, animLock=???
        Oka = 7485, // L45, instant, range 0, AOE circle 5/0, targets=self, animLock=???
        ...
        Fuko = 25780, // L86, instant, range 0, AOE circle 5/0, targets=self, animLock=???
        ...
        HissatsuGyoten = 7492, // L54, instant, 10.0s CD (group 5), range 20, single-target 0/0, targets=hostile, animLock=???
        HissatsuYaten = 7493, // L56, instant, 10.0s CD (group 6), range 5, single-target 0/0, targets=hostile, animLock=???
        Meditate = 7497, // L60, instant, 60.0s CD (group 11), range 0, single-target 0/0, targets=self, animLock=???
        HissatsuKyuten = 7491, // L62, instant, 1.0s CD (group 0), range 0, AOE circle 5/0, targets=self, animLock=???
        Hagakure = 7495, // L68, instant, 5.0s CD (group 4), range 0, single-target 0/0, targets=self, animLock=???
        Ikishoten = 16482, // L68, instant, 120.0s CD (group 19), range 0, single-target 0/0, targets=self, animLock=0.600s
        HissatsuGuren = 7496, // L70, instant, 120.0s CD (group 21), range 10, AOE rect 10/4, targets=hostile, animLock=???
        ...
        KaeshiHiganbana = 16484, // L76, instant, 60.0s CD (group 10) (2 charges), range 6, single-target 0/0, targets=hostile, animLock=???
        KaeshiGoken = 16485, // L76, instant, 60.0s CD (group 10) (2 charges), range 0, AOE circle 8/0, targets=self, animLock=???
        ...
        ShohaII = 25779, // L82, instant, 15.0s CD (group 8), range 0, AOE circle 5/0, targets=self, animLock=???
    ...
    public enum TraitID : uint
    {
        ...
        KenkiMasteryII = 208, // L62
        WayOfTheSamurai = 520, // L66
        EnhancedIaijutsu = 277, // L74
        EnhancedFugetsuAndFuka = 278, // L78
        EnhancedTsubameGaeshi = 442, // L84
        WayOfTheSamuraiII = 521, // L84
        FugaMastery = 519, // L86
    ...
    public static class Definitions
    {
        ...
        public static bool Unlocked(TraitID tid, int level, int questProgress)
        {
            return tid switch
            {
                ...
                TraitID.KenkiMasteryII => level >= 62,
                TraitID.WayOfTheSamurai => level >= 66,
                TraitID.EnhancedIaijutsu => level >= 74,
                TraitID.EnhancedFugetsuAndFuka => level >= 78,
                TraitID.EnhancedTsubameGaeshi => level >= 84,
                TraitID.WayOfTheSamuraiII => level >= 84,
        ...
        static Definitions()
        {
            ...
            SupportedActions.GCDCast(AID.Iaijutsu, 6, 1.8f);
            ...
            SupportedActions.OGCD(AID.HissatsuYaten, 5, CDGroup.HissatsuYaten, 10.0f);
            SupportedActions.OGCD(AID.Meditate, 0, CDGroup.Meditate, 60.0f).EffectDuration = 15;
            SupportedActions.OGCD(AID.HissatsuKyuten, 5, CDGroup.HissatsuKyuten, 1.0f);
            ...
            SupportedActions.OGCDWithCharges(AID.TsubameGaeshi, 6, CDGroup.TsubameGaeshi, 60.0f, 2);
            SupportedActions.OGCDWithCharges(AID.KaeshiHiganbana, 6, CDGroup.KaeshiHiganbana, 60.0f, 2);
            SupportedActions.OGCDWithCharges(AID.KaeshiGoken, 8, CDGroup.KaeshiGoken, 60.0f, 2);
            SupportedActions.OGCDWithCharges(AID.KaeshiSetsugekka, 6, CDGroup.KaeshiSetsugekka, 60.0f, 2);
            SupportedActions.OGCD(AID.Shoha, 3, CDGroup.Shoha, 15.0f);
            SupportedActions.OGCD(AID.ShohaII, 5, CDGroup.ShohaII, 15.0f);
